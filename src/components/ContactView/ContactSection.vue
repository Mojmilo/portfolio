<template>
    <section class="about">
        <div class="container-about">
            <h3 class="title"><span class="secondaire">{{ "<" }}</span> <span class="principal">contact</span> <span class="secondaire">{{ ">" }}</span></h3>
            <div class="container-global">
                ...
                <div class="img-about">
                    <img src="@/assets/moi.jpg" alt="" class="img-moi">
                    <div class="img-up"></div>
                </div>
            </div>
            <div class="button">
                <button class="download-cv" onclick="window.location.href='./CV.pdf';">Download my CV</button>
            </div>
            <h3 class="title"><span class="secondaire">{{ "<" }} /</span> <span class="principal">contact</span> <span class="secondaire">{{ ">" }}</span></h3>
        </div>
    </section>
    ...
    .about {
        ...
        .container-about {
            ...
            .button {
                ...
                .download-cv:hover {
                    background-color: var(--color-quatrième);
                }
            }
        }
    }
